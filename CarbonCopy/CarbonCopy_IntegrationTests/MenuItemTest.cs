...
namespace CarbonCopy_IntegrationTests
{
    [TestClass()]
    public class MenuItemTest
    {
        ...
        public void LaunchCommand()
        {
            ...
            {
                CommandID menuItemCmd = new CommandID(Zinc.CarbonCopy.GuidList.guidCarbonCopyCmdSet, (int)Zinc.CarbonCopy.PkgCmdIDList.cmdidCopyDeclaration);

                // Create the DialogBoxListener Thread.
                string expectedDialogBoxText = string.Format(CultureInfo.CurrentCulture, "{0}\n\nInside {1}.MenuItemCallback()", "CarbonCopy", "Zinc.CarbonCopy.CarbonCopyPackage");
