...
using Zinc.CarbonCopy;

namespace CarbonCopy_UnitTests.MenuItemTests
{
    [TestClass()]
    public class MenuItemTest
    {
        ...
        {
            // Create the package
            IVsPackage package = new CarbonCopyPackage() as IVsPackage;
            ...
            CommandID menuCommandID = new CommandID(Zinc.CarbonCopy.GuidList.guidCarbonCopyCmdSet, (int)Zinc.CarbonCopy.PkgCmdIDList.cmdidCopyDeclaration);
